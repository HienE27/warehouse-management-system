...
/**
 * Controller cho Lệnh nhập kho (Import Orders)
...
public class ImportOrderController {
    ...
    public ImportOrderController(RestTemplate restTemplate) {
    ...
    public ResponseEntity<?> search(
        ...
        String url = buildUrl("/api/orders/imports", status, code, from, to);
    ...
    public ResponseEntity<?> getById(
        ...
        String url = inventoryServiceUrl + "/api/orders/imports/" + id;
    ...
    public ResponseEntity<?> create(
        ...
        String url = inventoryServiceUrl + "/api/orders/imports";
    ...
    public ResponseEntity<?> approve(
        ...
        String url = inventoryServiceUrl + "/api/orders/imports/" + id + "/approve";
    ...
    public ResponseEntity<?> cancel(
        ...
        String url = inventoryServiceUrl + "/api/orders/imports/" + id + "/cancel";
