...
public class ImportServiceImpl implements ImportService {
    ...
    public SupplierImportDto create(SupplierImportRequest request) {
        ...
        try {
            ...
            sendActivityLog(uid, uname, "CREATE_RECEIPT", "IMPORT", im.getId(), im.getCode(), "Tạo phiếu nhập: " + im.getCode());
        } catch (Exception e) {
    ...
    public SupplierImportDto update(Long id, SupplierImportRequest request) {
        ...
        // Ghi nhật ký hoạt động: cập nhật phiếu nhập
        try {
            Long uid = getCurrentUserId();
            String uname = getCurrentUsername();
            if (uname == null) uname = "system";
            System.out.println("Preparing to send activity log: action=UPDATE_RECEIPT, resourceType=IMPORT, resourceId=" + im.getId() + ", userId=" + uid + ", username=" + uname + ", code=" + im.getCode());
            sendActivityLog(uid, uname, "UPDATE_RECEIPT", "IMPORT", im.getId(), im.getCode(), "Cập nhật phiếu nhập: " + im.getCode());
        } catch (Exception e) {
            logger.warn("Failed to send activity log for import update: {}", e.getMessage());
        }
    ...
    public SupplierImportDto approve(Long id) {
        ...
        try {
            ...
            sendActivityLog(uid, uname, "APPROVE_RECEIPT", "IMPORT", im.getId(), im.getCode(), "Duyệt phiếu nhập: " + im.getCode());
        } catch (Exception e) {
    ...
    public SupplierImportDto confirm(Long id) {
        ...
        try {
            ...
            String uname = getCurrentUsername();
            if (uname == null) uname = "system";
            System.out.println("Preparing to send activity log: action=CONFIRM_RECEIPT, resourceType=IMPORT, resourceId=" + im.getId() + ", userId=" + uid + ", username=" + uname + ", code=" + im.getCode());
            sendActivityLog(uid, uname, "CONFIRM_RECEIPT", "IMPORT", im.getId(), im.getCode(), "Xác nhận nhập kho: " + im.getCode());
        } catch (Exception e) {
    ...
    public SupplierImportDto cancel(Long id) {
        ...
        try {
            ...
            sendActivityLog(uid, uname, "CANCEL_RECEIPT", "IMPORT", im.getId(), im.getCode(), "Hủy phiếu nhập: " + im.getCode());
        } catch (Exception e) {
    ...
    public SupplierImportDto reject(Long id) {
        ...
        try {
            ...
            String uname = getCurrentUsername();
            if (uname == null) uname = "system";
            System.out.println("Preparing to send activity log: action=REJECT_RECEIPT, resourceType=IMPORT, resourceId=" + im.getId() + ", userId=" + uid + ", username=" + uname + ", code=" + im.getCode());
            sendActivityLog(uid, uname, "REJECT_RECEIPT", "IMPORT", im.getId(), im.getCode(), "Từ chối phiếu nhập: " + im.getCode());
        } catch (Exception e) {
    ...
    public void delete(Long id) {
        ...
        if ("ADMIN".equals(userRole)) {
            ...
            try {
                ...
                String uname = getCurrentUsername();
                if (uname == null) uname = "system";
                System.out.println("Preparing to send activity log: action=DELETE_RECEIPT, resourceType=IMPORT, resourceId=" + id + ", userId=" + uid + ", username=" + uname + ", code=" + importEntity.getCode());
                sendActivityLog(uid, uname, "DELETE_RECEIPT", "IMPORT", importEntity.getId(), importEntity.getCode(), "Xóa phiếu nhập: " + importEntity.getCode());
            } catch (Exception e) {
                logger.warn("Failed to send activity log for import delete: {}", e.getMessage());
            }
            return;
        }
